...
const caseStudyModules = import.meta.glob<{ default: CaseStudy }>('$lib/case-studies/*.ts', { eager: true });

// Convert the modules object into an array of case studies
export const caseStudies: CaseStudy[] = Object.values(caseStudyModules).map(module => module.default);
